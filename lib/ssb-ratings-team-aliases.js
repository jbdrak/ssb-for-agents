...
const TEAMS = Object.freeze({
  ...
  NFL: [
    ...
    ['Washington Commanders', ['Washington', 'Commanders', 'WSH', 'Washington Redskins']]
  ],
  NBA: [
    ...
    ['Golden State Warriors', ['Golden State', 'Warriors', 'GS']],
    ...
    ['Minnesota Timberwolves', ['Minnesota', 'Timberwolves', 'MIN']],
    ['New Orleans Pelicans', ['New Orleans', 'Pelicans', 'NO']],
    ['New York Knicks', ['New York', 'Knicks', 'NY']],
    ...
    ['Portland Trail Blazers', ['Portland', 'Trail Blazers', 'POR']],
    ['Sacramento Kings', ['Sacramento', 'Kings', 'SAC']],
    ['San Antonio Spurs', ['San Antonio', 'Spurs', 'SA']],
  ...
  NHL: [
    ...
    ['Los Angeles Kings', ['Los Angeles', 'Kings', 'LA']],
    ['Minnesota Wild', ['Minnesota', 'Wild', 'MIN']],
    ['Montreal Canadiens', ['Montreal', 'Canadiens', 'MTL']],
    ['Nashville Predators', ['Nashville', 'Predators', 'NSH']],
    ['New Jersey Devils', ['New Jersey', 'Devils', 'NJ']],
    ...
    ['San Jose Sharks', ['San Jose', 'Sharks', 'SJ']],
    ['Seattle Kraken', ['Seattle', 'Kraken', 'SEA']],
    ['St. Louis Blues', ['St Louis', 'Blues', 'STL']],
    ['Tampa Bay Lightning', ['Tampa Bay', 'Lightning', 'TB']],
  ...
  WNBA: [
    ['Atlanta Dream', ['Atlanta', 'Dream', 'ATL']],
    ['Chicago Sky', ['Chicago', 'Sky', 'CHI']],
    ['Connecticut Sun', ['Connecticut', 'Sun', 'CON']],
    ['Dallas Wings', ['Dallas', 'Wings', 'DAL']],
    ['Golden State Valkyries', ['Golden State', 'Valkyries', 'GS']],
    ['Indiana Fever', ['Indiana', 'Fever', 'IND']],
    ['Las Vegas Aces', ['Las Vegas', 'Aces', 'LV']],
    ['Los Angeles Sparks', ['Los Angeles', 'Sparks', 'LA']],
    ['Minnesota Lynx', ['Minnesota', 'Lynx', 'MIN']],
    ['New York Liberty', ['New York', 'Liberty', 'NY']],
    ['Phoenix Mercury', ['Phoenix', 'Mercury', 'PHX']],
    ['Portland Fire', ['Portland', 'Fire', 'POR']],
    ['Seattle Storm', ['Seattle', 'Storm', 'SEA']],
    ['Toronto Tempo', ['Toronto', 'Tempo', 'TOR']],
    ['Washington Mystics', ['Washington', 'Mystics', 'WSH']]
  ],
  MLS: [
    ['Atlanta United FC', ['Atlanta', 'ATL', 'Atlanta United']],
    ['Austin FC', ['Austin', 'ATX']],
    ['CF Montréal', ['Montreal', 'MTL']],
